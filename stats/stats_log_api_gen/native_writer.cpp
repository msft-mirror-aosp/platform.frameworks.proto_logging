...
void write_stats_log_header_preamble(FILE* out, const Atoms& atoms, const string& cppNamespace,
                                     bool bootstrap) {
    // Print prelude
    fprintf(out, "// This file is autogenerated\n");
    fprintf(out, "\n");
...
int write_stats_log_header(FILE* out, const Atoms& atoms, const AtomDecl& attributionDecl,
    ...
    write_stats_log_header_preamble(out, atoms, cppNamespace, bootstrap);
